		...
		<div class="header-aside">
			...
			if (
				...
				<?php if ( is_user_logged_in() ) { ?>
					...
					<a href="#" class="header-minimize-link course-toggle-view" data-balloon-pos="left" data-balloon="<?php esc_html_e( 'Show Sidepanel', 'buddyboss-theme' ); ?>"><i class="bb-icon-l bb-icon-minimize"></i></a>
				<?php } else {
					if ( $show_search ) : ?>
